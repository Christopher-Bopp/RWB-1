...
create table rwb_invitation(refcode varchar(8) primary key, permission varchar(128), referer varchar(20), status varchar(1), email varchar(256) not null UNIQUE, 
